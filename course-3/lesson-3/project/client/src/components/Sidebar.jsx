...
function Sidebar() {
  return (
    <>
      <header className="fixed w-full antialiased">
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-aut dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Component</span>
              </a>
            </li>
          </ul>
        </div>
