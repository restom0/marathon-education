...
<body>
  <header class="cd__intro">
    <h1> Neumorphism Login Form Example </h1>
    <p> Neumorphism Login Form </p>
    <div class="cd__action">
      <a href="https://www.codepel.com/forms/sliding-login-and-registration-form-using-html-css-and-javascript" title="Back to download and tutorial page" class="cd__btn back">Back to Tutorial</a>
    </div>
  </header>
  <main class="cd__main">
    <div class="main">
  ...
  <footer class="cd__credit">Author: Ricardo Oliva Alonso - Distributed By: <a title="Free web design code & scripts" href="https://www.codepel.com?source=demo-page" target="_blank">CodePel</a></footer>
    ...
    function register() {
      $('#submitsignupbtn').click(function(e) {
        ...
        if (email == '') {
          ...
          $.ajax({
            type: "post",
            url: "controller.php?action=register",
            data: {
              email: email,
              password: password
            },
